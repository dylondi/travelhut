...
import com.example.travelhut.views.main.map_search.flights.ApiClient;
import com.example.travelhut.views.main.map_search.flights.ApiService;
...
import com.example.travelhut.views.main.map_search.flights.TicketsAdapter;
...
public class FlightsActivity extends AppCompatActivity implements TicketsAdapter.TicketsAdapterListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.addItemDecoration(new FlightsActivity.GridSpacingItemDecoration(1, dpToPx(5), true));
